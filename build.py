...
COMPILER="g++ -g -std=c++20"   # The compiler we want to use 
                               #(You may try g++ if you have trouble)
SOURCE="./src/*.cpp ./src/gladfunctions/glad.c"     # Where the source code lives
...
if platform.system()=="Linux":
    ...
    INCLUDE_DIR="-I ./../common/include/ -I ./src/include/ -I ./src/include/glm-master/"
    LIBRARIES="-lSDL2 -ldl"
elif platform.system()=="Darwin":
    ARGUMENTS="-D MAC" # -D is a #define sent to the preprocessor.
    INCLUDE_DIR="-I ./../common/include/ -I/Library/Frameworks/SDL2.framework/Headers -I ./src/include/ -I ./src/include/glm-master/"
